...
const SERVER_MESSAGES = {
  zh: {
    ...
    mimoLoginExpired: '{provider} 的控制台登录态已过期(约 24 小时有效)。请重新登录 platform.xiaomimimo.com 并复制新的 Cookie。',
  ...
  en: {
    ...
    mimoLoginExpired: 'The {provider} console login has expired (cookies last about 24 hours). Log in at platform.xiaomimimo.com again and copy a fresh cookie.',
