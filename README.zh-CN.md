...
**v1.7.35**：新增百炼 CLI 额度来源、模型全名悬停提示，修复裸 gzip 响应解析，并为 GLM 额度查询提供逐端点诊断。详见[更新说明](docs/release-notes/v1.7.35.md)。
...
**PowerShell 一键脚本**(复制整行粘贴回车;自动补齐 pnpm、自动探测 git,无需克隆仓库;安装链**固定到发布 tag `v1.7.35`**,建议先下载审阅再运行):
