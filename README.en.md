...
[![version](https://img.shields.io/badge/version-1.7.26-4176E6)](https://github.com/Han-1413141/dsh-cost-meter)

**v1.7.26** adds an official Qianwen CLI quota source for subscription and add-on Credits, an option to show only Gemini quota groups in Antigravity, and decimal Credits plus loopback HTTP support for custom balances. See the [Qianwen CLI guide](docs/qwen-cli-quota.md#english).
...
**PowerShell one-click script** (copy the whole line, paste, press Enter; pnpm is provisioned automatically, git is auto-detected — no clone needed; the install chain is **pinned to the release tag `v1.7.26`** — review the script before running):
...
```sh
dsh plugin --profile web add github:Han-1413141/dsh-cost-meter#v1.7.26
```

Without git, use the GitHub tag archive:

```sh
dsh plugin --profile web add https://github.com/Han-1413141/dsh-cost-meter/archive/refs/tags/v1.7.26.tar.gz
```
