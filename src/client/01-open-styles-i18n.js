...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      // (变量名 --cm-bp 为字节上限压缩:src/client 与 lib 均有 262,144 硬门禁,长名会在 minify 后挤爆产物。)
      ':root{--cm-bp:rgb(57,100,254)}',
      ...
      '.cm-peak-low{background:var(--cm-bp)}',
      ...
      '.cm-peak-strip.off .cm-peak-chip{color:var(--cm-bp)}',
      ...
      '.cm-peak-classic.off .cm-peak-classic-marker{border-color:var(--cm-bp)}',
      '.cm-peak-classic.off .cm-peak-classic-marker::after{border-top-color:var(--cm-bp)}',
      ...
      '.cm-peak-classic.off .cm-peak-classic-chip{color:var(--cm-bp)}',
      ...
      '.cm-peak-rail-low{background:var(--cm-bp)}',
      ...
      '.cm-peak-rail.off .cm-peak-rail-label{color:var(--cm-bp)}',
      ...
      '.cm-peak-rail-classic-segment.off{background:var(--cm-bp);border-radius:0 0 999px 999px}',
      ...
      '.cm-peak-rail-classic.off .cm-peak-rail-classic-marker{border-color:var(--cm-bp)}',
      ...
      '.cm-peak-rail-classic.off .cm-peak-rail-classic-label{color:var(--cm-bp)}',
      ...
      '.cm-peak-dot-circle{flex:none;display:inline-block;width:9px;height:9px;border-radius:999px;background:var(--cm-bp);box-shadow:0 0 0 3px color-mix(in srgb,var(--cm-bp) 22%,transparent);transition:background .4s ease,box-shadow .4s ease}',
      '.cm-peak-dot.peak .cm-peak-dot-circle{background:#ff9800;box-shadow:0 0 0 3px color-mix(in srgb,#ff9800 22%,transparent)}',
      '.cm-peak-dot.off .cm-peak-dot-circle{background:var(--cm-bp);box-shadow:0 0 0 3px color-mix(in srgb,var(--cm-bp) 22%,transparent)}',
      ...
      '.cm-bbox-fill{height:100%;border-radius:999px;background:var(--cm-bp)}',
      '.cm-bbox-pct.cm-bal-amt{color:var(--cm-bp)}',
      ...
      '.cm-tb-amt.cm-tb-bal{color:var(--cm-bp)}',
      ...
      '.cm-tb-pop-bal{font-weight:700;color:var(--cm-bp)}',
