...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      // 插件定制主题色(浅蓝):余额/费用/Coding Plan/峰谷进度条统一引用。
      // 命名同构于宿主 token(--dsw-alias-state-business-primary),有意与其区分——主题默认蓝偏深。改色只动此一处。
      ':root{--cm-alias-state-business-primary:rgb(57,100,254)}',
      ...
      '.cm-peak-low{background:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-peak-strip.off .cm-peak-chip{color:var(--cm-alias-state-business-primary)}',
      // 周末全谷价(周六/周日全天按谷价):绿色标注,与峰(橙)/谷(蓝)明显区分。
      ...
      '.cm-peak-classic.off .cm-peak-classic-marker{border-color:var(--cm-alias-state-business-primary)}',
      '.cm-peak-classic.off .cm-peak-classic-marker::after{border-top-color:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-peak-classic.off .cm-peak-classic-chip{color:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-peak-rail-low{background:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-peak-rail.off .cm-peak-rail-label{color:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-peak-rail-classic-segment.off{background:var(--cm-alias-state-business-primary);border-radius:0 0 999px 999px}',
      ...
      '.cm-peak-rail-classic.off .cm-peak-rail-classic-marker{border-color:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-peak-rail-classic.off .cm-peak-rail-classic-label{color:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-peak-dot-circle{flex:none;display:inline-block;width:9px;height:9px;border-radius:999px;background:var(--cm-alias-state-business-primary);box-shadow:0 0 0 3px color-mix(in srgb,var(--cm-alias-state-business-primary) 22%,transparent);transition:background .4s ease,box-shadow .4s ease}',
      '.cm-peak-dot.peak .cm-peak-dot-circle{background:#ff9800;box-shadow:0 0 0 3px color-mix(in srgb,#ff9800 22%,transparent)}',
      '.cm-peak-dot.off .cm-peak-dot-circle{background:var(--cm-alias-state-business-primary);box-shadow:0 0 0 3px color-mix(in srgb,var(--cm-alias-state-business-primary) 22%,transparent)}',
      ...
      '.cm-bbox-fill{height:100%;border-radius:999px;background:var(--cm-alias-state-business-primary)}',
      '.cm-bbox-pct.cm-bal-amt{color:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-tb-amt.cm-tb-bal{color:var(--cm-alias-state-business-primary)}',
      ...
      '.cm-tb-pop-bal{font-weight:700;color:var(--cm-alias-state-business-primary)}',
