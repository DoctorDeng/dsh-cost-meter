  ...
  factory: (require) => {
    ...
    const MESSAGES = {
      zh: {
        ...
        customBalanceConfigNote: '请求头中的 {{ENV_VAR}} 从 DSH 凭据库或环境变量读取。extract 支持点路径、数值和 add/subtract/divide 运算；NewApi quota 除以 500000 得到美元。',
      ...
      en: {
        ...
        customBalanceConfigNote: 'Headers resolve {{ENV_VAR}} from DSH credentials or environment variables. Extract accepts paths, numbers and add/subtract/divide. Divide NewApi quota by 500000 for USD.',
