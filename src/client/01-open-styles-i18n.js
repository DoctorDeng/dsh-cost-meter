...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      '.cm-peak-high{background:rgb(57,100,254)}',
      '.cm-peak-low{background:rgb(57,100,254)}',
      ...
      '.cm-peak-strip.peak .cm-peak-chip{color:rgb(57,100,254)}',
      '.cm-peak-strip.off .cm-peak-chip{color:rgb(57,100,254)}',
      // 周末全谷价(周六/周日全天按谷价):与峰/谷同用淡蓝单色,阶段由文案与游标位置区分。
      '.cm-peak-strip.weekend .cm-peak-chip{color:rgb(57,100,254)}',
      ...
      '.cm-peak-classic-marker{position:absolute;top:0;left:50%;width:4px;height:12px;background:var(--dsw-alias-bg-base);border:1.5px solid rgb(57,100,254);box-shadow:0 0 0 1px var(--dsw-alias-bg-base),0 0 0 2px var(--dsw-alias-label-tertiary);transform:translateX(-50%);transition:left .4s ease;z-index:2;border-radius:2px}',
      '.cm-peak-classic-marker::after{content:"";position:absolute;top:-7px;left:50%;transform:translateX(-50%);border-left:5px solid transparent;border-right:5px solid transparent;border-top:6px solid rgb(57,100,254)}',
      '.cm-peak-classic.off .cm-peak-classic-marker{border-color:rgb(57,100,254)}',
      '.cm-peak-classic.off .cm-peak-classic-marker::after{border-top-color:rgb(57,100,254)}',
      ...
      '.cm-peak-classic.peak .cm-peak-classic-chip{color:rgb(57,100,254)}',
      '.cm-peak-classic.off .cm-peak-classic-chip{color:rgb(57,100,254)}',
      '.cm-peak-classic.weekend .cm-peak-classic-chip{color:rgb(57,100,254)}',
      '.cm-peak-classic.weekend .cm-peak-classic-marker{border-color:rgb(57,100,254)}',
      '.cm-peak-classic.weekend .cm-peak-classic-marker::after{border-top-color:rgb(57,100,254)}',
      ...
      '.cm-peak-rail-high{background:rgb(57,100,254)}',
      '.cm-peak-rail-low{background:rgb(57,100,254)}',
      ...
      '.cm-peak-rail.peak .cm-peak-rail-label{color:rgb(57,100,254)}',
      '.cm-peak-rail.off .cm-peak-rail-label{color:rgb(57,100,254)}',
      '.cm-peak-rail.weekend .cm-peak-rail-label{color:rgb(57,100,254)}',
      ...
      '.cm-peak-rail-classic-segment.peak{background:rgb(57,100,254);border-radius:999px 999px 0 0}',
      '.cm-peak-rail-classic-segment.off{background:rgb(57,100,254);border-radius:0 0 999px 999px}',
      '.cm-peak-rail-classic-marker{position:absolute;left:50%;top:50%;width:12px;height:4px;background:var(--dsw-alias-bg-base);border:1.5px solid rgb(57,100,254);box-shadow:0 0 0 1px var(--dsw-alias-bg-base),0 0 0 2px var(--dsw-alias-label-tertiary);transform:translate(-50%,-50%);transition:top .4s ease;z-index:2;border-radius:2px}',
      '.cm-peak-rail-classic.off .cm-peak-rail-classic-marker{border-color:rgb(57,100,254)}',
      '.cm-peak-rail-classic-label{font-size:10px;font-weight:600;line-height:1.2;white-space:nowrap}',
      '.cm-peak-rail-classic.peak .cm-peak-rail-classic-label{color:rgb(57,100,254)}',
      '.cm-peak-rail-classic.off .cm-peak-rail-classic-label{color:rgb(57,100,254)}',
      '.cm-peak-rail-classic.weekend .cm-peak-rail-classic-marker{border-color:rgb(57,100,254)}',
      '.cm-peak-rail-classic.weekend .cm-peak-rail-classic-label{color:rgb(57,100,254)}',
      ...
      '.cm-peak-dot-circle{flex:none;display:inline-block;width:9px;height:9px;border-radius:999px;background:rgb(57,100,254);box-shadow:0 0 0 3px color-mix(in srgb,rgb(57,100,254) 22%,transparent);transition:background .4s ease,box-shadow .4s ease}',
      '.cm-peak-dot.peak .cm-peak-dot-circle{background:#ff9800;box-shadow:0 0 0 3px color-mix(in srgb,#ff9800 22%,transparent)}',
      '.cm-peak-dot.off .cm-peak-dot-circle{background:rgb(57,100,254);box-shadow:0 0 0 3px color-mix(in srgb,rgb(57,100,254) 22%,transparent)}',
      ...
      '.cm-bbox-fill{height:100%;border-radius:999px;background:rgb(57,100,254)}',
      '.cm-bbox-pct.cm-bal-amt{color:rgb(57,100,254)}',
      ...
      '.cm-tb-amt.cm-tb-bal{color:rgb(57,100,254)}',
      ...
      '.cm-tb-pop-bal{font-weight:700;color:rgb(57,100,254)}',
